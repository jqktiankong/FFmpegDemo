...
#include "../../../../../ffmpeglibs/x86/include/libavformat/avformat.h"
#include "libavdevice/avdevice.h"
#include "../../../../../ffmpeglibs/x86/include/libswresample/swresample.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/opt.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/channel_layout.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/parseutils.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/samplefmt.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/fifo.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/hwcontext.h"
#include "libavutil/internal.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/intreadwrite.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/dict.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/display.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/mathematics.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/pixdesc.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/avstring.h"
#include "libavutil/libm.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/imgutils.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/timestamp.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/bprint.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/time.h"
#include "../../../../../ffmpeglibs/x86/include/libavutil/threadmessage.h"
#include "libavcodec/mathops.h"
#include "libavformat/os_support.h"

# include "../../../../../ffmpeglibs/x86/include/libavfilter/avfilter.h"
# include "../../../../../ffmpeglibs/x86/include/libavfilter/buffersrc.h"
# include "../../../../../ffmpeglibs/x86/include/libavfilter/buffersink.h"
...
#include "../../../../../ffmpeglibs/x86/include/libavutil/avassert.h"
...
static void update_benchmark(const char *fmt, ...) {
    if (do_benchmark_all) {
        ...
        if (fmt) {
            ...
            va_end(va);
            av_log(NULL, AV_LOG_INFO, "bench: %8"
            PRIu64
            " %s \n", t - current_time, buf);
        }
        current_time = t;
...
static void do_video_out(OutputFile *of,
    ...
    ist->st->first_dts != AV_NOPTS_VALUE && ost->frame_rate.num)
...
static int decode_audio(InputStream *ist, AVPacket *pkt, int *got_output,
    ...
    ist->next_pts += ((int64_t)
    AV_TIME_BASE * decoded_frame->nb_samples) /
    avctx->sample_rate;
    ist->next_dts += ((int64_t)
    AV_TIME_BASE * decoded_frame->nb_samples) /
    avctx->sample_rate;
#endif
        ...
        switch (ist->dec_ctx->codec_type) {
            case AVMEDIA_TYPE_AUDIO:
                if (ist->dec_ctx->sample_rate) {
                    ist->next_dts += ((int64_t)
                    AV_TIME_BASE * ist->dec_ctx->frame_size) /
...
static int init_output_stream_streamcopy(OutputStream *ost) {
    ...
    if (ost->rotate_overridden) {
        uint8_t * sd = av_stream_new_side_data(ost->st, AV_PKT_DATA_DISPLAYMATRIX,
                                               sizeof(int32_t) * 9);
        if (sd)
            av_display_rotation_set((int32_t * )
        sd, -ost->rotate_override_value);
    }
        ...
        if (ist) {
            ...
            for (i = 0; i < ist->st->nb_side_data; i++) {
                ...
                if (ist->autorotate && sd->type == AV_PKT_DATA_DISPLAYMATRIX)
                    av_display_rotation_set((uint32_t * )
                dst, 0);
            }
        }
...
static OutputStream *choose_output(void) {
    ...
    for (i = 0; i < nb_output_streams; i++) {
        OutputStream *ost = output_streams[i];
        int64_t
        opts = ost->st->cur_dts == AV_NOPTS_VALUE ? INT64_MIN :
...
static int process_input(int file_index) {
    ...
    if (!ist->wrap_correction_done && is->start_time != AV_NOPTS_VALUE && ist->st->pts_wrap_bits <
                                                                          64){
        ...
        if (stime2 > stime && pkt.dts != AV_NOPTS_VALUE && pkt.dts > stime + (1LL
                << (ist->st->pts_wrap_bits - 1))) {
            pkt.dts -= 1ULL << ist->st->pts_wrap_bits;
            ist->wrap_correction_done = 0;
        }
        if (stime2 > stime && pkt.pts != AV_NOPTS_VALUE && pkt.pts > stime + (1LL
                << (ist->st->pts_wrap_bits - 1))) {
